...
class StoreDetailsViewController: ViewController {
    ...
    private lazy var horizontalDateStackView: UIStackView = {
        ...
        horizontalDateStackView.spacing = 32
    ...
    private lazy var horizontalParticipantsStackView: UIStackView = {
        ...
        horizontalParticipantsStackView.spacing = 8
    ...
    private lazy var participantsLabel: UILabel = {
        ...
        participantsLabel.text = "Data final"
    ...
    private lazy var participantsContentLabel: UILabel = {
        ...
        participantsContentLabel.text = "1 biceps" //TODO "Recompensa da promoção"
    ...
    func configureSubviews() {
        ...
        horizontalButtonStackView.addArrangedSubview(endButton)
    ...
    func configureConstraints() {
        ...
        let descriptionStackViewContraints = [
            descriptionStackView.topAnchor.constraint(equalTo: card.topAnchor, constant: 16),
        ...
        let quantityStackViewContraints = [
            quantityStackView.topAnchor.constraint(equalTo: descriptionStackView.topAnchor, constant: 16),
            quantityStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            quantityStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
        
        let awardStackViewContraints = [
            awardStackView.topAnchor.constraint(equalTo: quantityStackView.topAnchor, constant: 16),
            awardStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            awardStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
        
        let datesStackViewContraints = [
            horizontalDateStackView.topAnchor.constraint(equalTo: awardStackView.topAnchor, constant: 16),
            horizontalDateStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            horizontalDateStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
        
        let horizontalParticipantsStackViewContraints = [
            horizontalParticipantsStackView.topAnchor.constraint(equalTo: horizontalDateStackView.topAnchor, constant: 16),
            horizontalParticipantsStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            horizontalParticipantsStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
        
        let horizontalButtonsStackViewContraints = [
            horizontalButtonStackView.topAnchor.constraint(equalTo: horizontalParticipantsStackView.topAnchor, constant: 16),
            horizontalButtonStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            horizontalButtonStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
        ...
        let verticalButtonsStackViewContraints = [
            ...
            verticalButtonStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            verticalButtonStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ]
